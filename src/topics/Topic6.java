...
public class Topic6 extends JFrame {
    ...
    public Topic6(String name) {
        this.name = name;
        setTitle("ALGORITMOS ASOCIADOS A LAS MT");
        setSize(1050, 700);
        ...
        htmlContentES = "<html><body style='text-align: center; color: white; font-family: Arial;' >"
                ...
                + "<h1 style='color: gray;'>ALGORITMOS ASOCIADOS A LAS MT</h1><br><br>"
        ...
        quiz.setBackground(new Color(44, 62, 80));
        quiz.setForeground(new Color(171, 178, 185));
        quiz.setFont(new Font("Arial", Font.BOLD, 12));
