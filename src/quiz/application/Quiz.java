...
public class Quiz extends JFrame implements ActionListener {
    ...
    public Quiz(String name) {
        ...
        qno.setForeground(new Color(171, 178, 185));
        add(qno);
        
        question = new JLabel();
        question.setBounds(150, 370, 900, 30);
        question.setForeground(new Color(171, 178, 185));
        ...
        answers[0][1] = "Estados, transiciones, acciones, movimientos";
        answers[1][1] = "Como círculos";
        answers[2][1] = "Todas las anteriores";
        answers[3][1] = "El estado en el que comienza la máquina";
        answers[4][1] = "Los lenguajes que pueden ser reconocidos por máquinas de Turing";
        answers[5][1] = "Una descripción formal de cómo una máquina de Turing realiza cálculos";
        answers[6][1] = "Máquinas de Turing que tienen más de una acción para cada estado";
        answers[7][1] = "Máquinas de Turing que tienen una cinta infinita";
        answers[8][1] = "Máquinas de Turing que tienen un almacenamiento secundario";
        answers[9][1] = "Máquinas de Turing que pueden leer y escribir símbolos continuamente";
        
        opt1 = new JRadioButton();
        opt1.setBounds(150, 430, 700, 30);
        opt1.setBackground(new Color(44, 62, 80));
        opt1.setFont(new Font("Dialog", Font.PLAIN, 20));
        add(opt1);
        
        opt2 = new JRadioButton();
        opt2.setBounds(150, 470, 700, 30);
        opt2.setBackground(new Color(44, 62, 80));
        opt2.setFont(new Font("Dialog", Font.PLAIN, 20));
        add(opt2);
        
        opt3 = new JRadioButton();
        opt3.setBounds(150, 510, 700, 30);
        opt3.setBackground(new Color(44, 62, 80));
        opt3.setFont(new Font("Dialog", Font.PLAIN, 20));
        add(opt3);
        
        opt4 = new JRadioButton();
        opt4.setBounds(150, 560, 700, 30);
        opt4.setBackground(new Color(44, 62, 80));
        ...
        lifeline.setBackground(new Color(44, 62, 80));
        lifeline.setForeground(new Color(171, 178, 185));
    ...
    public void start(int count) {
        ...
        opt1.setForeground(new Color(171, 178, 185));
        opt1.setActionCommand(questions[count][1]);
        
        opt2.setText(questions[count][2]);
        opt2.setActionCommand(questions[count][2]);
        opt2.setForeground(new Color(171, 178, 185));
        
        opt3.setText(questions[count][3]);
        opt3.setActionCommand(questions[count][3]);
        opt3.setForeground(new Color(171, 178, 185));
        
        opt4.setText(questions[count][4]);
        opt4.setActionCommand(questions[count][4]);
        opt4.setForeground(new Color(171, 178, 185));
